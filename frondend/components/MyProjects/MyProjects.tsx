...
import {CategoryModel, MyProjectsModel, ProjectModel} from "./MyProjects.model";
...
const MyProjects = ({
                        ...
                        categories,
                        projects
                    }: { myProject: MyProjectsModel, categories: CategoryModel[], projects: ProjectModel[] }) => {
    const all = {
        name: "All",
        id: 0
    }
    const [selectedCategory, setSelectedCategory] = useState<CategoryModel>(all);
    ...
    const filteredProjects =
        ...
        projects.filter(
            projects =>
                projects.categories.some(category =>
